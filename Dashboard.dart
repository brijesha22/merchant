...
class SalesLineChartWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Chart width: enough for all labels, all visible
    ...
    // If all values are zero, show a blue line for visual consistency (optional)
    if (lines.isEmpty) {
      lines.add(
        LineChartBarData(
                ...
                bottomTitles: AxisTitles(
                  sideTitles: SideTitles(
                    ...
                    getTitlesWidget: (double value, meta) {
                      ...
                      // No truncation, allow full label
                      return Padding(
                        padding: const EdgeInsets.only(top: 8.0),
                        child: Text(
                          label,
